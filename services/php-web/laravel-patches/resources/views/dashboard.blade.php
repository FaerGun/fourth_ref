      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        async function load(q){
          ...
          try{
            ...
            if (js.error) {
              const errorMsg = js.message || js.error;
              const errorCode = js.code ? ` (код: ${js.code})` : '';
              body.innerHTML = `<tr><td colspan="5" class="text-danger">Ошибка API: ${errorMsg}${errorCode}</td></tr>`;
              return;
            }
